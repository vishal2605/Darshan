...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private TextInputEditText registerFullName,registerDOB,registerAadhar,registerAddress,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerAadhar=findViewById(R.id.registerAadhar);
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(DOB)){
                    registerDOB.setError("Id Number is required!");
                    return;
                }
                ...
                if(TextUtils.isEmpty(Aadhar)){
                    registerDOB.setError("Aadhar is required!");
                    return;
                }
                if(TextUtils.isEmpty(DOB)){
                ...
                if(TextUtils.isEmpty(Address))
                    registerAddress.setError("Address is Empty");
                else {
